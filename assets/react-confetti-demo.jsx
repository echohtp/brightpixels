  ...
  return <>
    ...
    <section className="confetti-panel">
      <div className="confetti-controls">
        <p className="eyebrow">Brightpixels / React confetti</p>
        <h1>RAIN.<br/>PAUSE.<br/><em>REPEAT.</em></h1>
        <p className="lead">Real HDR confetti. One React component.<br/>An excellent use of perfectly good hardware.</p>
        ...
        <div className="confetti-options">
      ...
      <aside className="confetti-preview">
        ...
        <p className="note">WebGPU HDR when supported. Canvas fallback otherwise. Reduced motion gives one quiet batch of up to 12 sparkles. Fallback rendering caps simultaneous particles at 256.</p>
        <p className="note">Changes affect newly emitted pieces. Press “Make it rain” to start fresh. Physical brightness depends on your display, browser, and settings.</p>
      </aside>
    </section>
    <section className="confetti-code">
      <p className="eyebrow">YOUR NEXT SUCCESS SCREEN</p>
      <pre><code>{'import BrightConfetti from "brightpixels/react-confetti";\n\n<BrightConfetti\n  numberOfPieces={200}\n  recycle={false}\n  intensity={8}\n  onConfettiComplete={() => setCelebrating(false)}\n/>'}</code></pre>
      <p>React 18 or 19. Automatic viewport sizing. No window-size hook or confetti dependency. <a href="https://github.com/echohtp/brightpixels#confetti-and-react">API and migration notes ↗</a></p>
    </section>
  </>;
}
